...
<body>
  ...
  <section id="m-app" v-cloak>
    ...
    <a class="m-p-mse" target="_blank" href="https://github.com/Momo707577045/media-source-extract">无差别提取工具</a>
    ...
    <a class="m-p-final" target="_blank" href="https://github.com/Momo707577045/media-source-extract">下载的视频看不了？试试这个终结解决方案「无差别视频提取工具」，有配套「油猴」插件啦！！！</a>
    ...
    <div v-else class="m-p-tips" style="border: 1px solid #eeeeee; padding: 20px; border-radius: 10px;">
      ...
      <div style="display: flex; align-items: center; justify-content: center; margin-top: 20px;">
        <img src="https://upyun.luckly-mjw.cn/Assets/qrcode/tools.jpeg" alt="效率工具" title="logo" style="width: 500px;" />
        <img src="https://upyun.luckly-mjw.cn/Assets/qrcode/m3u8.jpeg" alt="m3u8 工具" title="logo" style="width: 500px;" />
      </div>
    </div>
  </section>
</body>
...
$vue.addEventListener('load', () => {
  ...
  new Vue({
    ...
    data() {
      return {
        url: 'https://videoofargo.erling0612.icu/download/Eia3CdYCNGD2eb6i/output.m3u8',
